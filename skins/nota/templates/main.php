...
<body>
  <div id="page_wrapper" class="{$SECTION_NAME}_wrapper">
	<div id="account">
	...
	<div class="sidebar" id="sidebar_right" style="float: left;">
		{$SEARCH_FORM}
		{$SHOPPING_CART}
		{$RANDOM_PROD}
  ...
  <div id="documents_wrapper">
	...
	<div id="documents_bottom">{if isset($SKIN_SELECT)}{$SKIN_SELECT}{/if} {$SITE_DOCS}</div>
  </div>
