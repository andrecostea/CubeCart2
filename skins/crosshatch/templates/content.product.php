	...
	<div id="review_write" style="display: none;">
		...
		<form action="{$VAL_SELF}#reviews_write" method="post">
			<fieldset>
				...
				<div>
					<label for="rev_review" class="return">{$LANG.catalogue.review}</label><span><textarea id="rev_review" name="review[review]" class="ckeditor" style="height: 70px; width:400px;" rows="10" cols="40">{$WRITE.review}</textarea></span>
				</div>
