...
$cbaServiceSubDomain = ($amazon_config['mode']=='sandbox') ? 'payments-sandbox' : 'payments';
$cbaServiceURL = 'https://'.$cbaServiceSubDomain.'.amazon.co.uk/cba/api/purchasecontract/';
...
define(CURRENCY_CODE,strtoupper($GLOBALS['config']->get('config','default_currency')));
